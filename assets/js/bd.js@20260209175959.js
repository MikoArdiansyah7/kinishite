document.addEventListener("DOMContentLoaded", () => {
    var t = document.querySelectorAll(".bl_bd_tab_container");
    ...
    t.forEach(t => {
        ...
        a = (a = n ? Array.from(e).find(t => t.getAttribute("data-tab-target") === n) : a) || (t.classList.contains("show-latest") ? e[e.length - 1] : e[0]),
